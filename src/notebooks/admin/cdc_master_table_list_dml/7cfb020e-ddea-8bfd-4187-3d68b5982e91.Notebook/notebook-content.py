...
spark.sql("""
    ...
    USING (
        SELECT
            ...
            '
SELECT
    CAST("SISH_SEQ_NBR" AS NUMBER(38,10)) AS "SISH_SEQ_NBR",
    "SLAY_LAYER",
    "SRNK_RANK",
    "STST_STOCKING_STATUS_ID",
    "STTP_STOCKING_TYPE_ID",
    ...
    CAST("SSSH_STOCK_HEIGHT" AS NUMBER(38,10)) AS "SSSH_STOCK_HEIGHT",
    CAST("SSSH_CROWN_CLOSURE" AS NUMBER(38,10)) AS "SSSH_CROWN_CLOSURE",
    CAST("SSSH_REFERENCE_YEAR" AS NUMBER(38,10)) AS "SSSH_REFERENCE_YEAR",
    "SICL_SITE_CLASS",
    ...
    CAST("SSSH_REENTRY_YEAR" AS NUMBER(38,10)) AS "SSSH_REENTRY_YEAR",
    "SSSH_CVR_PATTERN",
    "SSSH_RES_OBJECTIVE",
...
# ### Disable non-reporting forestview views
